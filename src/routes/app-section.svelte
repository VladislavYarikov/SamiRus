...
let descriptionArr = [
    ...
    'На карте отображаются только актуальные предложения от исполнителей и заявки от заказчиков. Если нет подходящих меток, то вы можете создать собственную. Ваше предложение обязательно увидят.',
    'Чтобы найти именно ту метку, которая вам необходима, используйте фильтр, расположенный в правом верхнем углу. В открывшемся меню выбирайте нужные пункты. Все прочие метки, кроме выбранных, отображаться на карте не будут.',
    'Номера телефонов заказчиков или исполнителей можно увидеть, кликнув на выбранную метку. Сами обговаривайте детали, время, место и цену.'
]
